...
title1, title2 = 'gray2gary', 'gray2color'
gray2gray = cv2.imread("../images/ch4/read_gray.jpg", cv2.IMREAD_GRAYSCALE)
gray2color = cv2.imread("../images/ch4/read_gray.jpg", cv2.IMREAD_COLOR)
