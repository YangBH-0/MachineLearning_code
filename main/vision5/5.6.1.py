...
src1 = np.array([1, 2, 3, 1, 2, 3], np.float32).reshape(2, 3)  # [2,3]
src2 = np.array([1, 2, 3, 4, 5, 6], np.float32).reshape(2, 3)  # [2,3]
src3 = np.array([1, 2, 1, 2, 1, 2], np.float32).reshape(3, 2)  # [3,2]
alpha, beta = 1.0, 1.0
